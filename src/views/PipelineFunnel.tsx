...
const STAGES = [
  { id: 'recruiter_screen',  label: 'Recruiter Screen',   color: '#1A2B4A' },
  { id: 'panel_interview',   label: 'Panel Interview',    color: '#1E3D6E' },
  { id: 'proposing_to_jd',   label: 'Proposing to JD',   color: '#2D5499' },
  { id: 'client_screening',  label: 'Client Screening',   color: '#4472C4' },
  { id: 'client_interview',  label: 'Client Interview',   color: '#6B9BD2' },
  { id: 'offer_letter',      label: 'Offer Letter',       color: '#9DC3E6' },
  { id: 'final_outcome',     label: 'Final Outcome',      color: '#C9DDEF' },
];
...
const AVATAR_COLORS = ['#1A2B4A','#1E3D6E','#2D5499','#4472C4','#6B9BD2','#9DC3E6','#C9DDEF'];
  ...
  return (
    <div className="pf-root">
      ...
      <div className="pf-topbar">
        <h2 className="pf-title">Pipeline</h2>
